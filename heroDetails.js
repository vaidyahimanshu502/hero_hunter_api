...
xhttp.onreadystatechange = function () {
  if (this.readyState == 4 && this.status == 200) {
    ...
    if (response.response === "error") {
      console.log("Oh ! Something Wnt wrong !!");
      return;
    }
    ...
    power.innerHTML =
      "<h1>POWER Possessing</h1><h4>Intelligence: " +
    ...
    bio.innerHTML =
      "<h1>BIOGRAPHY</h1><h4>Full-Name: " +
      response.biography.full -
      name +
      "</h4><h4>Alter-Egos: " +
      response.biography.alter -
      egos +
      "</h4><h4>Place-of-birth: " +
      response.biography.place -
      of -
      birth +
      "</h4><h4>First-Appearence: " +
...
xhttp.open(
  "GET",
  "https://www.superheroapi.com/api.php/3383566708344630/" +
    localStorage.getItem("heroSelected"),
  true
);
xhttp.send();
